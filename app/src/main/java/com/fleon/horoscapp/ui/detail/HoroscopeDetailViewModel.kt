...
import com.fleon.horoscapp.domain.model.HoroscopeModel
import com.fleon.horoscapp.domain.usecase.GetPredictionUseCase
    ...
    fun getHoroscope(sign: HoroscopeModel) {
        ...
        viewModelScope.launch {
            ...
            if (result != null) {
                ...
                _state.value = HoroscopeDetailState.Error("Has ocurrido un error, intenta nuevamente más tarde.")
            }
        }
    }
}